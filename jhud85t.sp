...
void JHUD_DrawStats(int client, int target)
{
	...
	if (g_iJump[target] == 1 && RoundToFloor(GetVectorLength(velocity)) < 280)
		...
		r = 0, g = 191, b = 255;
	else if (g_iJump[target] == 2 && RoundToFloor(GetVectorLength(velocity)) < 340)
		r = 255, g = 0, b = 0;
	else if (g_iJump[target] == 2 && RoundToFloor(GetVectorLength(velocity)) >= 340 && RoundToFloor(GetVectorLength(velocity)) <= 360)
		r = 255, g = 165, b = 0;
	else if (g_iJump[target] == 2 && RoundToFloor(GetVectorLength(velocity)) > 360 && RoundToFloor(GetVectorLength(velocity)) <= 380)
		r = 0, g = 255, b = 0;
	else if (g_iJump[target] == 2 && RoundToFloor(GetVectorLength(velocity)) > 380)
		r = 0, g = 191, b = 255;
	else if (g_iJump[target] == 3 && RoundToFloor(GetVectorLength(velocity)) < 390)
		r = 255, g = 0, b = 0;
	else if (g_iJump[target] == 3 && RoundToFloor(GetVectorLength(velocity)) >= 390 && RoundToFloor(GetVectorLength(velocity)) <= 420)
		r = 255, g = 165, b = 0;
	else if (g_iJump[target] == 3 && RoundToFloor(GetVectorLength(velocity)) > 420 && RoundToFloor(GetVectorLength(velocity)) <= 450)
		r = 0, g = 255, b = 0;
	else if (g_iJump[target] == 3 && RoundToFloor(GetVectorLength(velocity)) > 450)
		r = 0, g = 191, b = 255;
	else if (g_iJump[target] == 4 && RoundToFloor(GetVectorLength(velocity)) < 460)
		r = 255, g = 0, b = 0;
	else if (g_iJump[target] == 4 && RoundToFloor(GetVectorLength(velocity)) >= 460 && RoundToFloor(GetVectorLength(velocity)) <= 480)
		r = 255, g = 165, b = 0;
	else if (g_iJump[target] == 4 && RoundToFloor(GetVectorLength(velocity)) > 480 && RoundToFloor(GetVectorLength(velocity)) <= 490)
		r = 0, g = 255, b = 0;
	else if (g_iJump[target] == 4 && RoundToFloor(GetVectorLength(velocity)) > 490)
		r = 0, g = 191, b = 255;
	else if (g_iJump[target] == 5 && RoundToFloor(GetVectorLength(velocity)) < 480)
		r = 255, g = 0, b = 0;
	else if (g_iJump[target] == 5 && RoundToFloor(GetVectorLength(velocity)) >= 480 && RoundToFloor(GetVectorLength(velocity)) <= 510)
		r = 255, g = 165, b = 0;
	else if (g_iJump[target] == 5 && RoundToFloor(GetVectorLength(velocity)) > 510 && RoundToFloor(GetVectorLength(velocity)) <= 520)
		r = 0, g = 255, b = 0;
	else if (g_iJump[target] == 5 && RoundToFloor(GetVectorLength(velocity)) > 520)
		r = 0, g = 191, b = 255;
	else if (g_iJump[target] == 6 && RoundToFloor(GetVectorLength(velocity)) < 510)
		r = 255, g = 0, b = 0;
	else if (g_iJump[target] == 6 && RoundToFloor(GetVectorLength(velocity)) >= 510 && RoundToFloor(GetVectorLength(velocity)) <= 565)
		r = 255, g = 165, b = 0;
	else if (g_iJump[target] == 6 && RoundToFloor(GetVectorLength(velocity)) > 565 && RoundToFloor(GetVectorLength(velocity)) <= 590)
		r = 0, g = 255, b = 0;
	else if (g_iJump[target] == 6 && RoundToFloor(GetVectorLength(velocity)) > 590)
		r = 0, g = 191, b = 255;
	else if (g_iJump[target] == 16 && RoundToFloor(GetVectorLength(velocity)) < 780)
		r = 255, g = 0, b = 0;
	else if (g_iJump[target] == 16 && RoundToFloor(GetVectorLength(velocity)) >= 780 && RoundToFloor(GetVectorLength(velocity)) <= 820)
		r = 255, g = 165, b = 0;
	else if (g_iJump[target] == 16 && RoundToFloor(GetVectorLength(velocity)) > 820 && RoundToFloor(GetVectorLength(velocity)) <= 850)
		r = 0, g = 255, b = 0;
	else if (g_iJump[target] == 16 && RoundToFloor(GetVectorLength(velocity)) > 850)
		r = 0, g = 191, b = 255;
